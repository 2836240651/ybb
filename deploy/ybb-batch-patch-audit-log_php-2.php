...
$target = __DIR__ . '/wp-content/mu-plugins/ybb-site-manager/includes/modules/audit-log.php';
$raw = base64_decode((string) file_get_contents(__DIR__ . '/ybb-batch-audit-log_php-2.b64'), true);

...
$current_lang = function_exists('determine_locale') ? substr(determine_locale(), 0, 2) : 'en';
...
<main class="ybb-checkout-page" lang="<?php echo esc_attr($current_lang); ?>">
    <header class="ybb-checkout-topbar">
        ...
        <div class="ybb-lang" aria-label="Language links">
            <a href="?lang=en">EN</a><span>/</span><a href="?lang=zh">中文</a>
        </div>
    </header>
